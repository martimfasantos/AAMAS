...
def main(game_count, render, fires, agents, mode, debug, size=16, c=False):
    register(
...
if __name__ == "__main__":
    ...
    parser.add_argument("--mode", type=int, default=0, help="How should agents behave (0 - Randomly, 1 - Pseudo-randomly)")

    args = parser.parse_args()
    main(args.times, args.render, args.fires, args.agents, args.mode, args.debug)
